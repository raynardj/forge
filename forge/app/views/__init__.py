...
from .ml_view import taskView, formatView, hyperParamView, weightView, trainView, hyperParamLogView, metricView, \
    metricLogView
...
appbuilder.add_view(trainView, "Trains", icon="fa-soccer-ball-o",**ml_cate)
...
appbuilder.add_separator(category=ml_cate["category"])
appbuilder.add_view(metricView, "Metrics", icon="fa-star-half-o", **ml_cate)
appbuilder.add_view(metricLogView, "Metric Log", icon="fa-line-chart", **ml_cate)
